...
```
[역사적 사건/인물] → [원리/발견] → [자연스러운 문제 제기] → [한계/새로운 문제]
...
```
[기존 방식 소개] → [한계 드러남] → [핵심 문제 선언] → [새로운 접근 필요]
...
- [ ] 추상적 서술("빠르다", "크다")이 구체적 수치/값으로 뒷받침되는가?
- [ ] 인과 관계에서 암묵적 전제(중간 단계)가 생략되지 않았는가?
- [ ] 초보자가 외부 자료 없이 이해할 수 있는 수준으로 설명되었는가?
...
- [ ] 추상적 서술이 구체적 수치/값으로 뒷받침됨
- [ ] 인과 관계에서 암묵적 전제가 생략되지 않음
- [ ] 다이어그램/코드의 구체적 이름이 산문에서 일관 사용됨
