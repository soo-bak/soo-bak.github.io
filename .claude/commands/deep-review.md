...
### 산문 우선
수정 시 설명이 필요한 항목은 불릿 리스트가 아닌 산문(문단)으로 풀어 씁니다. 독자 시뮬레이션에서도 불릿 나열이 산문으로 전환되었는지 점검합니다.
...
| 추상적 서술 | 구체적이지 않아 독자가 감을 잡을 수 없음 | "빠르게 처리됩니다" (얼마나?), "인터페이스" (어떤 인터페이스?) |
| 암묵적 전제 | 중간 단계 생략으로 논리를 따라가기 어려움 | "평면적 목록이므로 이름 충돌이 발생했다" (왜?) |
...
4. **반복**: 중복 문장/문단 제거
5. **추상적 서술**: 구체적 수치/이름으로 교체하거나 보충
6. **암묵적 전제**: 생략된 중간 단계를 추가하여 논리적 간극 해소
...
- [ ] "이건 구체적으로 뭔데?"라고 느끼는 추상적 서술이 있는가?
- [ ] "왜 그런 거지?"라고 느끼는 암묵적 전제 생략 지점이 있는가?
...
2. **미답변 질문**: 해당 섹션 내에서 답변을 추가하여 완결
...
- 구체적이지 않아 독자가 감을 잡을 수 없는 추상적 서술이 있는가?
- 중간 단계가 생략되어 논리를 따라가기 어려운 암묵적 전제가 있는가?
