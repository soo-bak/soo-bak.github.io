...
### 대상 독자
**초보자**가 외부 자료 없이 이 글만으로 이해할 수 있는 수준을 기준으로 합니다. 흐름을 다듬을 때 초보자가 따라올 수 있는 속도와 난이도를 고려합니다.
...
- [ ] 인과 관계에서 중간 단계가 생략되어 독자가 추론해야 하는 곳이 있는가?
- [ ] 추상적 표현("인터페이스", "브릿지") 대신 다이어그램/코드의 구체적 이름(veth-a, br0)을 사용하고 있는가?
...
4. **암묵적 전제 채우기**: 인과 관계에서 생략된 중간 단계를 추가하여 흐름 단절 해소

### 점검 항목
- [ ] 섹션 내에서 문장 간 논리적 도약이 있는가?
- [ ] 문단의 마지막 문장과 다음 문단의 첫 문장 사이에 단절이 있는가?
- [ ] 앞 문장의 키워드가 다음 문장에서 자연스럽게 이어지는가?
- [ ] 전방 참조 메타 문장("뒤에서 다시 다룹니다", "다음 섹션에서 설명합니다")이 사용되지 않았는가?
...
- [ ] 설명이 필요한 항목이 불릿 리스트로만 나열되어 있는가? → 산문으로 전환
...
- [ ] 불필요하거나 중복된 예시가 없는가?
- [ ] 전방 참조 메타 문장이 없는가?
- [ ] 설명이 필요한 항목이 불릿 나열이 아닌 산문으로 되어 있는가?
- [ ] 인과 관계의 중간 단계가 생략되어 흐름이 끊기는 곳이 없는가?
- [ ] 다이어그램/코드의 구체적 이름이 산문에서도 일관되게 사용되는가?
