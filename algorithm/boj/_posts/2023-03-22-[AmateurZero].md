...
description: 구현을 주제로 하는 백준 27257번 알고리즘 문제를 C# 과 C++ 로 풀이 및 해설
tags:
  - 백준
  - BOJ
  - 27257
  ...
  - C++
  - 알고리즘
keywords: "백준 27257, 백준 27257번, BOJ 27257, C# 풀이, C++ 풀이, 알고리즘"
---
...
## 설명
  ...
  입력은 숫자로 주어지지만, 간단한 구현을 위하여 문자열로 입력을 받고 처리했습니다.<br>
