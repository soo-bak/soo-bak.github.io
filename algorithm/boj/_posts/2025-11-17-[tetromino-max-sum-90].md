...
tags:
  ...
  - C++
  - 알고리즘
keywords: "백준 14500, 백준 14500번, BOJ 14500, C# 풀이, C++ 풀이, 알고리즘"
---
...
19가지 테트로미노 모양을 상대 좌표로 미리 정의합니다.

예를 들어 `I` 모양의 가로 배치는 `{(0,0), (0,1), (0,2), (0,3)}`으로 표현됩니다.
