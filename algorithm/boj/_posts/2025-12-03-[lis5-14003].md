---
layout: single
title: "[백준 14003] 가장 긴 증가하는 부분 수열 5 (C#, C++) - soo:bak"
date: "2025-12-03 01:03:00 +0900"
description: O(N log N) LIS와 경로 복원으로 수열까지 출력하는 백준 14003번 가장 긴 증가하는 부분 수열 5 문제의 C# 및 C++ 풀이와 해설
tags:
  - 백준
  - BOJ
  - 14003
  ...
  - traceback
  - lis
keywords: "백준 14003, 백준 14003번, BOJ 14003, lis5, C# 풀이, C++ 풀이, 알고리즘"
---
...
이 문제는 [14002번 - 가장 긴 증가하는 부분 수열 4](https://www.acmicpc.net/problem/14002)과 동일한 문제이지만, N이 최대 백만까지 가능하고 값의 범위가 -10억부터 10억까지입니다.
