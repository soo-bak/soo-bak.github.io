...
**제약 조건**:
- 원소가 **정수**여야 함
- 원소의 범위가 **제한적**이어야 함 ($$k$$가 너무 크면 비효율적)
...
계수 정렬이 효율적인 경우:
- $$k = O(n)$$일 때 (범위가 원소 수에 비례)
- 예: 나이(0~150), 성적(0~100), ASCII 문자(0~127)
...
[기수 정렬](https://soo-bak.github.io/algorithm/theory/radix-sort/)에서 각 자릿수 정렬에 계수 정렬을 사용합니다.
...
범위가 작은 정수 데이터에서는 비교 기반 정렬보다 훨씬 빠르게 정렬할 수 있습니다.

<br>

### 관련 글
- [기수 정렬(Radix Sort)의 원리와 구현 - soo:bak](https://soo-bak.github.io/algorithm/theory/radix-sort/)
