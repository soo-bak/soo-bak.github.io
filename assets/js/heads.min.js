!(function (e, t) {
      ...
      if (
        ...
        if (11 !== f && (s = ne.exec(t)))
          if ((l = s[1])) {
            ...
            } else if (c && (o = c.getElementById(l)) && m(e, o) && o.id === l)
              return n.push(o), n;
          } else {
            ...
            if (
              ...
              return R.apply(n, e.getElementsByClassName(l)), n;
          }
        if (
          d.qsa &&
          !q[t + " "] &&
          ...
          if (((l = t), (c = e), 1 === f && G.test(t))) {
            for (
              ...
              u[i] = "#" + a + " " + ye(u[i]);
            (l = u.join(",")), (c = (re.test(t) && ge(e.parentNode)) || e);
          }
          try {
    ...
    function we(d, h, g, v, y, e) {
      return (
        ...
        le(function (e, t, n, r) {
          ...
          } else (p = be(p === t ? p.splice(l, p.length) : p)), y ? y(null, t, p, r) : R.apply(t, p);
        })
      );
    }
    function Te(v, y) {
  ...
  (E.filter = function (e, t, n) {
    ...
    E.fn.extend({
      ...
      is: function (e) {
        return !!j(this, "string" == typeof e && N.test(e) ? E(e) : e || [], !1)
          .length;
      },
    });
  var q = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/;
        ...
        E.fn[r] = function (e, t) {
          ...
          return (
            (t = "Until" !== r.slice(-5) ? e : t) &&
              ...
              (n = E.filter(t, n)),
            1 < this.length &&
              (O[r] || E.uniqueSort(n), H.test(r) && n.reverse()),
            this.pushStack(n)
          );
        };
      }
          ...
          a = {
            ...
            then: function (t, n, r) {
              ...
              return E.Deferred(function (e) {
                o[0][3].add(l(0, e, g(r) ? r : M, e.notifyWith)),
                  o[1][3].add(l(0, e, g(t) ? t : M)),
                  o[2][3].add(l(0, e, g(n) ? n : I));
              }).promise();
            },
            promise: function (e) {
  ...
  function _(e, t, n, r, i, o, a) {
    var s = 0,
      u = e.length,
      l = null == n;
    if ("object" === h(n)) for (s in ((i = !0), n)) _(e, t, s, n[s], !0, o, a);
    else if (
      void 0 !== r &&
      ((i = !0),
      g(r) || (a = !0),
          ...
          return "object" == typeof n
            ...
            : _(
                ...
                function (e) {
                  var t;
                  return o && void 0 === e
                    ? void 0 !== (t = J.get(o, n)) || void 0 !== (t = ee(o, n))
                      ? t
                      : void 0
            ...
            "" === r.style.display &&
              ...
              (s[u] =
                ...
                (i = le[a]) ||
                  ...
                  (le[a] = i = "none" === i ? "block" : i)))))
          : "none" !== n && ((s[u] = "none"), Q.set(r, "display", n)));
  ...
  function me(e, t, n, r, i) {
    ...
    for (c.textContent = "", p = 0; (o = f[p++]); )
      if (r && -1 < E.inArray(o, r)) i && i.push(o);
        ...
        ((u = ie(o)), (a = ge(c.appendChild(o), "script")), u && ve(a), n)
      )
    ...
    special: {
      ...
      click: {
        setup: function (e) {
          e = this || e;
          return (
            fe.test(e.type) && e.click && A(e, "input") && ke(e, "click", Te),
            !1
          );
        },
        trigger: function (e) {
          e = this || e;
          return (
            fe.test(e.type) && e.click && A(e, "input") && ke(e, "click"), !0
          );
        },
        _default: function (e) {
          e = e.target;
  ...
  function Oe(e, t) {
    ...
    if (1 === t.nodeType) {
      if (
        Q.hasData(e) &&
        ((o = Q.access(e)), (a = Q.set(t, o)), (s = o.events))
      )
  ...
  function Pe(n, r, i, o) {
    ...
    var e,
      ...
      d = r[0],
      h = g(d);
    if (h || (1 < f && "string" == typeof d && !x.checkClone && De.test(d)))
    ...
    if (
      ...
      for (s = (a = E.map(ge(e, "script"), Le)).length; c < f; c++)
        (u = e),
          c !== p &&
  ...
  E.extend({
    ...
    (E.cssHooks.marginLeft = Qe(x.reliableMarginLeft, function (e, t) {
      if (t)
        return (
  ...
  (E.Animation = E.extend(yt, {
    ...
    tweener: function (e, t) {
      for (
        var n, r = 0, i = (e = g(e) ? ((t = e), ["*"]) : e.match(R)).length;
        r < i;
        r++
      )
        (n = e[r]),
          ...
          p))
            u ||
              (g
                ...
                : (g = Q.access(e, "fxshow", { display: l })),
              o && (g.hidden = !h),
              h && ce([e], !0),
              f.done(function () {
                for (r in (h || ce([e]), Q.remove(e, "fxshow"), p))
                  E.style(e, r, p[r]);
              })),
              (u = vt(h ? g[r] : 0, r, f)),
              r in g ||
        ...
        return "boolean" == typeof t && a
          ...
          : this.each(function () {
              ...
              if (a)
                ...
                (void 0 !== i && "boolean" != o) ||
                  ((e = Ct(this)) && Q.set(this, "__className__", e),
                  this.setAttribute &&
                    this.setAttribute(
                      "class",
      ...
      if (
        ...
        for (i = 0; (h = f[i++]) && !e.isPropagationStopped(); )
          (c = h),
            ...
            (u = (Q.get(h, "events") || {})[e.type] && Q.get(h, "handle")) &&
              u.apply(h, t),
            (u = s && h[s]) &&
              u.apply &&
              G(h) &&
    ...
    E.extend({
      ...
      ajax: function (e, t) {
        ...
        if (
          ...
          if (((b.readyState = 1), d && v.trigger("ajaxSend", [b, h]), p))
            return b;
          h.async &&
            0 < h.timeout &&
        ...
        function w(e, t, n, r) {
          ...
          p ||
            ...
            (b.status = e),
            (b.statusText = (t || s) + ""),
            r ? y.resolveWith(g, [i, s, b]) : y.rejectWith(g, [b, s, o]),
            b.statusCode(x),
            (x = void 0),
            d && v.trigger(r ? "ajaxSuccess" : "ajaxError", [b, h, r ? i : o]),
            m.fireWith(g, [b, s]),
            d &&
  ...
  E.ajaxSetup({
    ...
    E.each(["top", "left"], function (e, n) {
      E.cssHooks[n] = Qe(x.pixelPosition, function (e, t) {
        if (t)
          return (t = Ye(e, n)), Ue.test(t) ? E(e).position()[n] + "px" : t;
      });
    }),
