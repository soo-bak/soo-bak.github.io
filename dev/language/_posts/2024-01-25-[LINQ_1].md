...
description: "C# LINQ의 기본 개념과 사용법을 설명합니다. from, where, orderby, groupby, select 등 핵심 키워드를 다룹니다."
tags:
  - C#
  - LINQ
  - .NET
  - 프로그래밍
  - 데이터 처리
keywords: "LINQ, C#, Language Integrated Query, from, where, select, orderby, groupby, .NET"
---
<br>
...
```
: 이 예시에서 `select` 는 쿼리 결과로 `person` 객체의 `Name` 과 `Age` 속성만 포함하는 새로운 익명 타입을 생성한다.
<br>
<br>
<br>
