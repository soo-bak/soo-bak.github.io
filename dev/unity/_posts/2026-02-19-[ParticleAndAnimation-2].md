...
<div style="text-align: center; margin: 1.5em 0;">
<svg viewBox="0 0 560 430" xmlns="http://www.w3.org/2000/svg" style="max-width: 560px; width: 100%;">
  <text x="280" y="22" text-anchor="middle" font-family="sans-serif" font-size="14" font-weight="bold" fill="currentColor">Animation (Legacy) 구조</text>

  <text x="40" y="50" font-family="sans-serif" font-size="12" font-weight="bold" fill="currentColor">Animation 컴포넌트 — 클립 목록</text>

  <rect x="40" y="62" width="480" height="86" rx="5" fill="currentColor" fill-opacity="0.06" stroke="currentColor" stroke-width="1.2"/>
  <text x="60" y="82" font-family="sans-serif" font-size="11" fill="currentColor">├── Walk 클립</text>
  <text x="60" y="102" font-family="sans-serif" font-size="11" fill="currentColor">├── Run 클립</text>
  <text x="60" y="122" font-family="sans-serif" font-size="11" fill="currentColor">└── Attack 클립</text>
  <text x="60" y="142" font-family="sans-serif" font-size="10" font-style="italic" fill="currentColor">상태 머신 없이 클립을 직접 보유</text>

  <line x1="40" y1="165" x2="520" y2="165" stroke="currentColor" stroke-width="1" stroke-dasharray="3,3"/>

  <text x="40" y="188" font-family="sans-serif" font-size="12" font-weight="bold" fill="currentColor">매 프레임 처리</text>

  <rect x="40" y="202" width="480" height="48" rx="5" fill="currentColor" fill-opacity="0.06" stroke="currentColor" stroke-width="1.2"/>
  <text x="60" y="222" font-family="sans-serif" font-size="12" font-weight="bold" fill="currentColor">1) 시간 갱신</text>
  <text x="60" y="240" font-family="sans-serif" font-size="11" fill="currentColor">시간 += deltaTime × 재생 속도</text>

  <rect x="40" y="258" width="480" height="48" rx="5" fill="currentColor" fill-opacity="0.06" stroke="currentColor" stroke-width="1.2"/>
  <text x="60" y="278" font-family="sans-serif" font-size="12" font-weight="bold" fill="currentColor">2) 키프레임 보간</text>
  <text x="60" y="296" font-family="sans-serif" font-size="11" fill="currentColor">현재 시간에 해당하는 값 계산</text>

  <rect x="40" y="314" width="480" height="48" rx="5" fill="currentColor" fill-opacity="0.06" stroke="currentColor" stroke-width="1.2"/>
  <text x="60" y="334" font-family="sans-serif" font-size="12" font-weight="bold" fill="currentColor">3) Transform / 프로퍼티 적용</text>
  <text x="60" y="352" font-family="sans-serif" font-size="11" fill="currentColor">계산된 값을 대상에 기록</text>

  <line x1="40" y1="378" x2="520" y2="378" stroke="currentColor" stroke-width="1" stroke-dasharray="3,3"/>

  <text x="280" y="400" text-anchor="middle" font-family="sans-serif" font-size="11" fill="currentColor">상태 머신 없음 · 블렌드 트리 없음 · 트랜지션 자동 처리 없음</text>
  <text x="280" y="418" text-anchor="middle" font-family="sans-serif" font-size="11" font-style="italic" fill="currentColor">→ 오버헤드가 적음</text>
</svg>
</div>
...
| 기존 프로젝트 호환 | Animation (Legacy) | 이미 Legacy로 작성된 에셋, 단순 클립 재생만 필요 |
...
모바일에서 2 Bones를 권장하는 이유는 두 가지입니다. 4 Bones 대비 행렬 연산이 절반으로 줄고, 관절 부위(팔꿈치, 무릎)의 변형 차이가 모바일 화면에서 미미하기 때문입니다.
...
| 높은 Skin Weights | 정점당 행렬 연산 증가, 4 Bones는 2배 비용 | 2 Bones로 설정 (모바일 기준) |
